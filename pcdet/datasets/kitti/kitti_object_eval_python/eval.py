...
def clean_data(gt_anno, dt_anno, current_class, difficulty):
    ...
    # CLASS_NAMES = ['vehicle', 'truck', 'othercar', 'trafficsign', 'trafficlight']
    ...
    for i in range(num_gt):
        ...
        if (gt_name == current_cls_name):
            valid_class = 1
#ghjin        elif (current_cls_name == "Pedestrian".lower()
#ghjin              and "Person_sitting".lower() == gt_name):
#ghjin            valid_class = 0
#ghjin        elif (current_cls_name == "Car".lower() and "Van".lower() == gt_name):
#ghjin            valid_class = 0
        else:
            valid_class = -1
        ignore = False
        ...
        if valid_class == 1 and not ignore:
            ...
            ignored_gt.append(-1)
    # for i in range(num_gt):
#ghjin        if gt_anno["name"][i] == "DontCare":
#ghjin            dc_bboxes.append(gt_anno["bbox"][i])
...
def get_official_eval_result(gt_annos, dt_annos, current_classes, PR_detail_dict=None):
    ...
    #                         [0.5, 0.25, 0.25, 0.5, 0.25, 0.5]])
    overlap_0_7 = np.array([[0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7],
                            [0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5],
                            [0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3]])
    overlap_0_5 = np.array([[0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7],
                            [0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5],
                            [0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3]])
    ...
    if len(current_classes) > 1:
        ...
        if mAPbbox is not None:
            mAPbbox_all = mAPbbox.mean(axis=0)
            result += 'bbox AP:{:.4f}, {:.4f}, {:.4f}\n'.format(
                *mAPbbox_all[:, 0])
        if mAPbev is not None:
            mAPbev_all = mAPbev.mean(axis=0)
